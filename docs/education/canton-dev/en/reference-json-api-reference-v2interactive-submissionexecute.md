---
title: "/v2/interactive-submission/execute"
slug: "reference-json-api-reference-v2interactive-submissionexecute"
locale: "en"
category: "reference"
source_url: "https://docs.canton.network/reference/json-api-reference/v2interactive-submissionexecute.md"
source_title: "/v2/interactive-submission/execute"
tags:
  - reference
  - json-api-reference
  - v2interactive-submissionexecute
---
...
````yaml /openapi/json-ledger-api/openapi.yaml post /v2/interactive-submission/execute
openapi: 3.0.3
info:
...
paths:
  /v2/interactive-submission/execute:
    post:
      summary: /v2/interactive-submission/execute
      description: >-
        Execute a prepared submission _asynchronously_ on the ledger.

        Requires a signature of the transaction from the submitting external
        party.
