...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-topology-admin-v30-topologymanagerreadservice-listsynchronizerparametersstate"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-topology-admin-v30/topologymanagerreadservice/listsynchronizerparametersstate.md"
source_title: "ListSynchronizerParametersState"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    <div class="x2mdx-ref-breadcrumbs" role="navigation" aria-label="Breadcrumb">
      ...
      <span>List同步器ParametersState</span>
    </div>

    <div class="x2mdx-ref-hero">
      <p class="x2mdx-ref-eyebrow">com.digitalasset.canton.topology.admin.v30</p>

      <h1 class="x2mdx-ref-title">List同步器ParametersState</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/List同步器ParametersState</code>
    </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>List同步器ParametersStateRequest</h3>
      </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>List同步器ParametersStateResponse</h3>
      </div>
    ...
    ## 相关模式<手风琴组>
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List同步器ParametersStateRequest">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List同步器ParametersStateResponse">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List同步器ParametersStateResponse.Result">
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/List同步器ParametersState <<'EOF'
        {
          "baseQuery": {
            "store": {
              "authorized": {}
