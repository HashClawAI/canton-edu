...
* **您的任何一方是否需要与外部 Canton Network 各方进行交易？** 如果是，您需要 全局同步器 连接。请考虑使用[混合模式](/zh/docs/canton/global-synchronizer-extension-synchronizers-hybrid-synchronizer-pattern)。
