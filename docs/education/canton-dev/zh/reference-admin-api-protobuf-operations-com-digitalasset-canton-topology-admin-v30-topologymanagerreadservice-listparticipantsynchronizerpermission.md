...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-topology-admin-v30-topologymanagerreadservice-listparticipantsynchronizerpermission"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-topology-admin-v30/topologymanagerreadservice/listparticipantsynchronizerpermission.md"
source_title: "ListParticipantSynchronizerPermission"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    <div class="x2mdx-ref-breadcrumbs" role="navigation" aria-label="Breadcrumb">
      ...
      <span>List参与方同步器Permission</span>
    </div>

    <div class="x2mdx-ref-hero">
      <p class="x2mdx-ref-eyebrow">com.digitalasset.canton.topology.admin.v30</p>

      <h1 class="x2mdx-ref-title">List参与方同步器Permission</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/List参与方同步器Permission</code>
    </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>List参与方同步器PermissionRequest</h3>
      </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>List参与方同步器PermissionResponse</h3>
      </div>
    ...
    ## 相关模式<手风琴组>
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List参与方同步器PermissionRequest">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List参与方同步器PermissionResponse">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List参与方同步器PermissionResponse.Result">
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/List参与方同步器Permission <<'EOF'
        {
          "baseQuery": {
            "store": {
              "authorized": {}
