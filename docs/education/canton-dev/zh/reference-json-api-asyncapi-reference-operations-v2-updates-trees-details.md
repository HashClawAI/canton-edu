...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">获取更新交易树流。为向后兼容而提供，它将在 Canton 3.5.0 版本中删除，改用 v2/updates。</p>
...
<div class="x2mdx-ref-card-grid">
  <a class="x2mdx-ref-card" href="/zh/docs/canton/reference-json-api-asyncapi-reference-operations-v2-updates-trees-publish">
    ...
    <p class="x2mdx-ref-card-summary">将 GetUpdatesRequest 消息从客户端发布到 /v2/updates/trees。</p>
  ...
  <a class="x2mdx-ref-card" href="/zh/docs/canton/reference-json-api-asyncapi-reference-operations-v2-updates-trees-subscribe">
    ...
    <p class="x2mdx-ref-card-summary">从订阅流上的 /v2/updates/trees 接收 \_JsCantonError\_JsGetUpdateTreesResponse 消息。</p>
