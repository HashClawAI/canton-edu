...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-admin-participant-v30-synchronizerconnectivityservice-disconnectsynchronizer"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-admin-participant-v30/synchronizerconnectivityservice/disconnectsynchronizer.md"
source_title: "DisconnectSynchronizer"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    ...
    <div class="x2mdx-ref-hero">
      ...
      <h1 class="x2mdx-ref-title">断开同步器</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.admin.参与方.v30.同步器ConnectivityService/Disconnect同步器</code>
    </div>
    ...
    <手风琴组>
      <手风琴标题=“com.digitalasset.canton.admin.参与方.v30.Disconnect同步器Request”>
      ...
      </手风琴><手风琴标题=“com.digitalasset.canton.admin.参与方.v30.Disconnect同步器Response”>
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.admin.参与方.v30.同步器ConnectivityService/Disconnect同步器 <<'EOF'
        {
          "同步器Alias": "string"
        }
        EOF
