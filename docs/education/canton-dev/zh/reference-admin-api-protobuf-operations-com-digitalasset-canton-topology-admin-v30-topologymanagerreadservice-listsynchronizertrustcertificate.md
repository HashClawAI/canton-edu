...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-topology-admin-v30-topologymanagerreadservice-listsynchronizertrustcertificate"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-topology-admin-v30/topologymanagerreadservice/listsynchronizertrustcertificate.md"
source_title: "ListSynchronizerTrustCertificate"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    <div class="x2mdx-ref-breadcrumbs" role="navigation" aria-label="Breadcrumb">
      ...
      <span>List同步器TrustCertificate</span>
    </div>

    <div class="x2mdx-ref-hero">
      <p class="x2mdx-ref-eyebrow">com.digitalasset.canton.topology.admin.v30</p>

      <h1 class="x2mdx-ref-title">List同步器TrustCertificate</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/List同步器TrustCertificate</code>
    </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>List同步器TrustCertificateRequest</h3>
      </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>List同步器TrustCertificateResponse</h3>
      </div>
    ...
    ## 相关模式<手风琴组>
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List同步器TrustCertificateRequest">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List同步器TrustCertificateResponse">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.List同步器TrustCertificateResponse.Result">
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/List同步器TrustCertificate <<'EOF'
        {
          "baseQuery": {
            "store": {
              "authorized": {}
