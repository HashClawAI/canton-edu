---
title: "CIP 索引"
slug: "overview-reference-cip-index"
locale: "zh"
category: "overview"
source_url: "https://docs.canton.network/overview/reference/cip-index.md"
source_title: "CIP Index"
tags:
  - overview
  - reference
  - cip-index
...
多数 CIP 为 Governance 提案，涵盖 Super Validator 入驻、委员会组建与运营政策。下文列出部分重要治理 CIP。完整集合（60+ 项治理提案）见 [CIP repository](https://github.com/global-synchronizer-foundation/cips)。
...
<Info>
  本索引反映撰写时 CIP 仓库状态，可能不含此后新增提案。最新提案请始终查阅 [GitHub repository](https://github.com/global-synchronizer-foundation/cips)。
</Info>
