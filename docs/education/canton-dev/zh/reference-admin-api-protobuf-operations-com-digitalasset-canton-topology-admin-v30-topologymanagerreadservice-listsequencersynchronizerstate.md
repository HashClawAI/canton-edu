...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-topology-admin-v30-topologymanagerreadservice-listsequencersynchronizerstate"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-topology-admin-v30/topologymanagerreadservice/listsequencersynchronizerstate.md"
source_title: "ListSequencerSynchronizerState"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    <div class="x2mdx-ref-breadcrumbs" role="navigation" aria-label="Breadcrumb">
      ...
      <span>ListSequencer同步器State</span>
    </div>

    <div class="x2mdx-ref-hero">
      <p class="x2mdx-ref-eyebrow">com.digitalasset.canton.topology.admin.v30</p>

      <h1 class="x2mdx-ref-title">ListSequencer同步器State</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/ListSequencer同步器State</code>
    </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>ListSequencer同步器StateRequest</h3>
      </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>ListSequencer同步器StateResponse</h3>
      </div>
    ...
    ## 相关模式<手风琴组>
      <Accordion title="com.digitalasset.canton.topology.admin.v30.ListSequencer同步器StateRequest">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.ListSequencer同步器StateResponse">
      ...
      <Accordion title="com.digitalasset.canton.topology.admin.v30.ListSequencer同步器StateResponse.Result">
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.topology.admin.v30.TopologyManagerReadService/ListSequencer同步器State <<'EOF'
        {
          "baseQuery": {
            "store": {
              "authorized": {}
