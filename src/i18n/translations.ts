  ...
  en: {
    ...
    ecosystem: {
      ...
      wallets: [
        ...
        { name: 'CanPocket.AI', desc: 'Invite-only self-custody member wallet — keys generated and stored in-browser; transfers signed locally', url: 'https://canpocket.ai/' },
      ...
      payments: [
        ...
        {
          name: 'HIFI',
          desc: 'Stablecoin infrastructure and onchain repo / cash-leg orchestration on Canton (fiat→USDC→USDCx)',
          url: 'https://hifi.com/',
        },
        {
          name: 'Canpay.ai',
      ...
      infra: [
        ...
        { name: 'WalletConnect', desc: 'Wallet connectivity for Canton apps — 700+ wallets, one integration', url: 'https://walletconnect.com/' },
        { name: 'CredShields', desc: 'Official audit partner — Daml / smart contract security reviews', url: 'https://credshields.com/' },
  ...
  zh: {
    ...
    ecosystem: {
      ...
      wallets: [
        ...
        { name: 'CanPocket.AI', desc: '邀请制自托管会员钱包——私钥在浏览器本地生成与保管，转账在本设备签名', url: 'https://canpocket.ai/' },
      ...
      payments: [
        ...
        {
          name: 'HIFI',
          desc: 'Canton 稳定币基础设施与链上回购/现金腿编排（法币→USDC→USDCx）',
          url: 'https://hifi.com/',
        },
        {
          name: 'Canpay.ai',
      ...
      infra: [
        ...
        { name: 'WalletConnect', desc: 'Canton 应用的钱包连接层——支持 700+ 钱包，一次集成', url: 'https://walletconnect.com/' },
        { name: 'CredShields', desc: '官方审计合作伙伴——Daml / 智能合约安全审计', url: 'https://credshields.com/' },
