...
export const translations = {
      ...
      items: [
        {
          date: '2026-06-18',
          tag: 'Media',
          title: 'Canton blog: Quadrillions recap — the crypto capital of the world is being built in America',
          body: 'Official Canton Network blog (June 18, 2026): Quadrillions recap with Acting CFTC Chair Caroline Pham on the CFTC’s “back to basics” approach, SEC cooperation, and the 12-month Crypto Sprint—covering tokenized collateral, stablecoin regulation, global market harmonization, and U.S. leadership in onchain finance. Blockworks × Canton miniseries; episode page at canton.network/blog/the-crypto-capital-of-the-world.',
          url: 'https://www.canton.network/blog/the-crypto-capital-of-the-world',
        },
        {
          date: '2026-06-17',
          tag: 'Institutional',
  ...
  zh: {
    ...
    news: {
      ...
      items: [
        { date: '2026-06-18', tag: '媒体', title: 'Canton 官方博客：Quadrillions 纪要——全球加密之都正在美国构建', body: 'Canton Network 官方博客（2026-06-18）：Quadrillions 纪要，CFTC 代理主席 Caroline Pham 谈 CFTC「回归基础」监管路径、与 SEC 协作及 12 个月 Crypto Sprint——涵盖代币化抵押品、稳定币监管、全球市场协调与美国在链上金融中的领导地位。Blockworks × Canton 迷你系列；节目页见 canton.network/blog/the-crypto-capital-of-the-world。', url: 'https://www.canton.network/blog/the-crypto-capital-of-the-world' },
