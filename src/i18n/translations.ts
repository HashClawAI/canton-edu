...
export const translations = {
      ...
      items: [
        {
          date: '2026-06-26',
          tag: 'Protocol',
          title: 'MainNet Protocol 35 topology freeze begins (LSU completes June 27)',
          body: 'Canton Network Forum alert (June 18, 2026): MainNet Logical Synchronizer Upgrade to Protocol Version 35 enters topology freeze at 13:00 UTC today (9 am US Eastern), with the LSU completing June 27 at 13:00 UTC—completing Canton 3.4→3.5 Phase 3 on MainNet after TestNet finished June 17. Validators must run Splice ≥0.6.5 before freeze; nodes below 0.6.5 require manual recovery. Party onboarding and package vetting pause ~24 hours pre-LSU; Splice 0.6.7 is required by June 30 ahead of traffic-based app rewards (MainNet July 28).',
          url: 'https://forum.canton.network/t/alert-mainnet-logical-synchronizer-upgrade-june-26-june-27/8800',
        },
        {
          date: '2026-06-26',
          tag: 'Institutional',
          title: 'FTSE Russell June 2026 reconstitution takes effect (Russell 3000 / 2000)',
          body: 'LSEG / FTSE Russell (June 2026 semi-annual reconstitution): Updated Russell US index membership—including preliminary additions such as Canton Strategic Holdings (NASDAQ: CNTN) to the Russell 3000 and Russell 2000—takes effect after US market close June 26, 2026, with recalibrated indexes operating from the June 29 open. Rank-day data is as of April 30, 2026; CNTN’s June 18 PRNewswire release cited its Canton-aligned equity exposure strategy.',
          url: 'https://www.lseg.com/en/media-centre/press-releases/ftse-russell/2026/ftse-russell-begins-june-2026-semi-annual-russell-us-indexes-reconstitution',
        },
        {
          date: '2026-06-23',
          tag: 'Ecosystem',
          title: 'Bithumb lists Canton Coin (CC/KRW) on Canton Mainnet',
          body: 'Bithumb official notice (June 23, 2026, 11:27 KST): CC added to the Korean won market—deposits/withdrawals within two hours of the notice, trading from 14:00 KST, reference price 234 KRW, Canton Mainnet only (1 confirmation). Bithumb describes Canton as privacy-preserving institutional infrastructure with Daml smart contracts; CC as the Mainnet utility token for traffic fees and infrastructure rewards. New-listing trading limits apply per venue rules.',
          url: 'https://feed.bithumb.com/notice/1653835',
        },
        {
          date: '2026-06-23',
          tag: 'Ecosystem',
          title: 'Palladium Labs launches Genesis Fund (10M CC builder grants)',
          body: 'Chainwire / Business Insider (June 23, 2026): Palladium Labs opened the Genesis Fund—a 10 million CC (~$1.5M) grant program for developers, researchers, and startups building financial apps, infrastructure, tooling, integrations, and research on Canton. Multiple funding tiers include technical guidance and ecosystem introductions; applications at palladiumlabs.org/grant. Launch follows Digital Asset’s $355M Canton round and Bithumb’s CC/KRW listing the same day.',
          url: 'https://markets.businessinsider.com/news/currencies/palladium-labs-launches-genesis-fund-to-accelerate-builder-growth-on-canton-1036268318',
        },
        {
          date: '2026-06-20',
          tag: 'Governance',
  ...
  zh: {
    ...
    news: {
      ...
      items: [
        { date: '2026-06-26', tag: '协议', title: 'MainNet Protocol 35 拓扑冻结开始（LSU 6 月 27 日完成）', body: 'Canton Network 论坛告警（2026-06-18）：MainNet Logical Synchronizer 升级至协议版本 35 于今日 13:00 UTC（美东 9:00）进入拓扑冻结，LSU 于 6 月 27 日 13:00 UTC 完成——在 TestNet 于 6 月 17 日完成后，MainNet 完成 Canton 3.4→3.5 第三阶段。验证者须在冻结前运行 Splice ≥0.6.5；低于 0.6.5 需手动恢复。参与方 onboarding 与包 vetting 在 LSU 前约 24 小时暂停；6 月 30 日前须升级至 Splice 0.6.7 以配合流量型应用奖励（MainNet 7 月 28 日上线）。', url: 'https://forum.canton.network/t/alert-mainnet-logical-synchronizer-upgrade-june-26-june-27/8800' },
        { date: '2026-06-26', tag: '机构', title: 'FTSE Russell 2026 年 6 月指数重组生效（Russell 3000 / 2000）', body: 'LSEG / FTSE Russell（2026 年 6 月半年度重组）：Russell 美国指数更新成分——含初步新增名单中的 Canton Strategic Holdings（NASDAQ: CNTN）纳入 Russell 3000 与 Russell 2000——于 2026-06-26 美股收盘后生效，重组后指数自 6 月 29 日开盘运行。排名日数据为 2026-04-30；CNTN 于 6 月 18 日 PRNewswire 稿强调其 Canton 对齐股权敞口战略。', url: 'https://www.lseg.com/en/media-centre/press-releases/ftse-russell/2026/ftse-russell-begins-june-2026-semi-annual-russell-us-indexes-reconstitution' },
        { date: '2026-06-23', tag: '生态', title: 'Bithumb 上线 Canton Coin（CC/KRW，Canton Mainnet）', body: 'Bithumb 官方公告（2026-06-23 11:27 KST）：CC 加入韩元市场——公告后 2 小时内开放充提，14:00 KST 起交易，参考价 234 韩元，仅支持 Canton Mainnet（1 次确认）。Bithumb 介绍 Canton 为隐私型机构级基础设施与 Daml 智能合约网络；CC 为 Mainnet 流量费与基础设施奖励的实用代币。新上币交易限制以所内规则为准。', url: 'https://feed.bithumb.com/notice/1653835' },
        { date: '2026-06-23', tag: '生态', title: 'Palladium Labs 推出 Genesis Fund（1000 万 CC 建设者资助）', body: 'Chainwire / Business Insider（2026-06-23）：Palladium Labs 开放 Genesis Fund——1000 万 CC（约 150 万美元）资助计划在 Canton 上构建金融应用、基础设施、工具、集成与研究的开发者、研究者与初创团队。多档资助含技术指导与生态对接；申请见 palladiumlabs.org/grant。发布同日伴随 Digital Asset 3.55 亿美元 Canton 融资与 Bithumb CC/KRW 上币。', url: 'https://markets.businessinsider.com/news/currencies/palladium-labs-launches-genesis-fund-to-accelerate-builder-growth-on-canton-1036268318' },
    ...
    resources: {
      ...
      exchanges: [
        ...
        { name: 'Bithumb', pairs: 'CC/KRW（仅 Canton Mainnet；以所内规则为准）' },
