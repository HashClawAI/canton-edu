...
export const translations = {
      ...
      items: [
        {
          date: '2026-06-23',
          tag: 'Institutional',
          title: 'Canton Strategic launches CC locking-as-a-service (CIP-0105 / CIP-0116)',
          body: 'PRNewswire (June 23, 2026): Canton Strategic Holdings (NASDAQ: CNTN) announced a locking-as-a-service offering to help Super Validators and Featured App builders meet CC commitment requirements under CIP-0105 (SV reward locking) and CIP-0116 (Featured App per-PartyId locks). The program was piloted with Super Validators in April; CEO Mark Wendland cited aligned long-term incentives. Forward-looking statements and DA trademark disclaimers apply per release.',
        ...
        },
        {
          date: '2026-06-23',
          tag: 'Exchange',
          title: 'Bithumb lists CC in KRW market (Canton Mainnet only)',
          body: 'Bithumb official notice (June 23, 2026): South Korea’s Bithumb added Canton (CC) to its Korean won market—deposits/withdrawals within two hours of the notice, trading from 14:00 KST, reference price 234 KRW. Only Canton Mainnet is supported (no cross-chain deposits). New-listing limit-order rules apply per venue policy.',
          url: 'https://feed.bithumb.com/notice/1653835',
        },
        {
          date: '2026-06-22',
          tag: 'Governance',
          title: 'Edel Finance locks 25M CC for Featured App status (CIP-0116)',
          body: 'Edel Finance (@edeldotfinance) locked 25 million CC to maintain Featured App designation—the asset-issuer threshold per PartyId under CIP-0116. CantonNews wire archived the public post dated June 22, 2026 alongside other Featured App lock announcements; 60-day vesting unlock rules are defined in the approved CIP-0116 spec.',
          url: 'https://cantonnews.org/wire/another-packed-week-for-canton-network-2026-06-22',
        },
        {
          date: '2026-06-22',
          tag: 'Governance',
          title: 'Nuxaris locks 5M CC for Featured App status (CIP-0116)',
          body: 'Nuxaris (@Nuxaris) locked 5 million CC in compliance with CIP-0116 to maintain Featured App status—the non-issuer threshold per PartyId for its cross-chain bridge on Canton. CantonNews wire archived the public post dated June 22, 2026; lock requirements and 60-day vesting rules are defined in the approved CIP-0116 spec.',
          url: 'https://cantonnews.org/wire/another-packed-week-for-canton-network-2026-06-22',
        },
        {
          date: '2026-06-20',
  ...
  zh: {
    ...
    news: {
      ...
      items: [
        { date: '2026-06-23', tag: '机构', title: 'Canton Strategic 推出 CC 锁仓即服务（CIP-0105 / CIP-0116）', body: 'PRNewswire（2026-06-23）：Canton Strategic Holdings（NASDAQ: CNTN）宣布推出锁仓即服务，帮助超级验证者与 Featured App 建设者满足 CIP-0105（SV 奖励锁仓）与 CIP-0116（Featured App 按 PartyId 锁仓）的 CC 承诺要求。该服务 4 月已与超级验证者试点；CEO Mark Wendland 强调长期激励对齐。前瞻性表述与 DA 商标免责声明以原文为准。', url: 'https://www.prnewswire.com/news-releases/canton-strategic-holdings-inc-announces-launch-of-locking-service-to-support-network-infrastructure-providers-302807710.html' },
        { date: '2026-06-23', tag: '交易所', title: 'Bithumb 上线 CC 韩元交易对（仅 Canton 主网）', body: 'Bithumb 官方公告（2026-06-23）：韩国 Bithumb 将 Canton（CC）加入韩元市场——公告后 2 小时内开放充提，14:00 KST 起交易，参考价 234 韩元。仅支持 Canton 主网（不支持跨链充值）。新币上架限单等规则以交易所政策为准。', url: 'https://feed.bithumb.com/notice/1653835' },
        { date: '2026-06-22', tag: '治理', title: 'Edel Finance 锁仓 2500 万 CC 维持精选应用资格（CIP-0116）', body: 'Edel Finance（@edeldotfinance）锁仓 2500 万 CC 以维持 Featured App 资格——CIP-0116 下资产发行方每个 PartyId 的门槛。CantonNews 线报归档了 2026-06-22 的公开帖（同周其他 Featured App 锁仓公告）；60 天线性解锁规则见已通过的 CIP-0116 正文。', url: 'https://cantonnews.org/wire/another-packed-week-for-canton-network-2026-06-22' },
        { date: '2026-06-22', tag: '治理', title: 'Nuxaris 锁仓 500 万 CC 维持精选应用资格（CIP-0116）', body: 'Nuxaris（@Nuxaris）按 CIP-0116 锁仓 500 万 CC 以维持 Featured App 资格——其 Canton 跨链桥作为非发行方应用每个 PartyId 的门槛。CantonNews 线报归档了 2026-06-22 的公开帖；锁仓要求与 60 天线性解锁规则见已通过的 CIP-0116 正文。', url: 'https://cantonnews.org/wire/another-packed-week-for-canton-network-2026-06-22' },
