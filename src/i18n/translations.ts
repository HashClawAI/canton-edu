...
export const translations = {
  ...
  zh: {
    ...
    home: {
      ...
      disclaimer:
        'Canton Tools 是以开源方式由社区维护的教育类网站。本站部分内容可能经人工辅助及人工智能体（AI Agent）与自动化工具进行汇集、摘要、编排或更新；该等过程不排除存在错误、遗漏或时效滞后。除适用法律强制性规定外，本站内容按「现状」及「可提供」之基础提供，不就其完整性、准确性、时效性、特定用途之适用性或无侵权等，作任何明示或默示之担保。Canton Foundation、Digital Asset（瑞士）有限公司、Canton Network 及其参与方未对本站予以赞助、背书、审查或承担任何责任，亦不因本站内容而与您构成任何隶属、代理、合伙或类似法律关系。对「Canton」及相关名称之使用，仅以教育性、陈述性方式指称第三方项目或生态，不构成对 Canton 相关商标之授权，亦不构成任何商业合作之主张；正式标识与商标使用规则以 https://www.canton.network/brand-kit-trademark-use 为准。本站所载不构成亦不可替代投资、财务、税务或法律意见；您应自行核对一手官方资料并咨询适格专业人士。',
    },
    learn: {
      title: '学习路径',
