---
title: "ClearSchedule"
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-admin-participant-v30-pruningservice-clearschedule"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-admin-participant-v30/pruningservice/clearschedule.md"
source_title: "ClearSchedule"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    ...
    <div class="x2mdx-ref-hero">
      ...
      <h1 class="x2mdx-ref-title">清除时间表</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.admin.参与方.v30.PruningService/ClearSchedule</code>
    </div>
    ...
    <手风琴组>
      <手风琴标题=“com.digitalasset.canton.admin.pruning.v30.ClearScheduleRequest”>
        <div class="x2mdx-ref-schema" id="schema-com-digitalasset-canton-admin-pruning-v30-clearschedulerequest" />
      </手风琴>

      <手风琴标题=“com.digitalasset.canton.admin.pruning.v30.ClearScheduleResponse”>
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.admin.参与方.v30.PruningService/ClearSchedule <<'EOF'
        {}
        EOF
        ```
      </div>
