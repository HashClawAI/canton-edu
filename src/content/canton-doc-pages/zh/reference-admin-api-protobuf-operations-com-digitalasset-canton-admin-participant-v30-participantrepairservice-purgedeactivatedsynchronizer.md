...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-admin-participant-v30-participantrepairservice-purgedeactivatedsynchronizer"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-admin-participant-v30/participantrepairservice/purgedeactivatedsynchronizer.md"
source_title: "PurgeDeactivatedSynchronizer"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    <div class="x2mdx-ref-breadcrumbs" role="navigation" aria-label="Breadcrumb">
      ...
      <span>PurgeDeactivated同步器</span>
    </div>

    <div class="x2mdx-ref-hero">
      <p class="x2mdx-ref-eyebrow">com.digitalasset.canton.admin.参与方.v30</p>

      <h1 class="x2mdx-ref-title">PurgeDeactivated同步器</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.admin.参与方.v30.参与方RepairService/PurgeDeactivated同步器</code>
    </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>PurgeDeactivated同步器Request</h3>
      </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>PurgeDeactivated同步器Response</h3>
      </div>
    ...
    <手风琴组>
      <手风琴标题=“com.digitalasset.canton.admin.参与方.v30.PurgeDeactivated同步器Request”>
      ...
      </手风琴><手风琴标题=“com.digitalasset.canton.admin.参与方.v30.PurgeDeactivated同步器Response”>
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.admin.参与方.v30.参与方RepairService/PurgeDeactivated同步器 <<'EOF'
        {
          "同步器Alias": "string"
        }
        EOF
