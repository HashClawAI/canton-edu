...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-admin-participant-v30-synchronizerconnectivityservice-disconnectallsynchronizers"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-admin-participant-v30/synchronizerconnectivityservice/disconnectallsynchronizers.md"
source_title: "DisconnectAllSynchronizers"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    ...
    <div class="x2mdx-ref-hero">
      ...
      <h1 class="x2mdx-ref-title">断开所有同步器</h1>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.admin.参与方.v30.同步器ConnectivityService/DisconnectAll同步器s</code>
    </div>
    ...
    <div class="x2mdx-ref-panel">
      <div class="x2mdx-ref-panel-head">
        <h3>DisconnectAll同步器sResponse</h3>
      </div>
    ...
    <手风琴组>
      <手风琴标题=“com.digitalasset.canton.admin.参与方.v30.DisconnectAll同步器sRequest”>
        <div class="x2mdx-ref-schema" id="schema-com-digitalasset-canton-admin-参与方-v30-disconnectall同步器srequest" />
      </手风琴>

      <手风琴标题=“com.digitalasset.canton.admin.参与方.v30.DisconnectAll同步器sResponse”>
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.admin.参与方.v30.同步器ConnectivityService/DisconnectAll同步器s <<'EOF'
        {}
        EOF
        ```
      </div>
