---
title: "SetCron"
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-admin-participant-v30-pruningservice-setcron"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-admin-participant-v30/pruningservice/setcron.md"
source_title: "SetCron"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.admin.参与方.v30.PruningService/SetCron</code>
    </div>
    ...
    <手风琴组>
      <手风琴标题=“com.digitalasset.canton.admin.pruning.v30.SetCronRequest”>
      ...
      <手风琴标题=“com.digitalasset.canton.admin.pruning.v30.SetCronResponse”>
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.admin.参与方.v30.PruningService/SetCron <<'EOF'
        {
          "cron": "string"
        }
        EOF
