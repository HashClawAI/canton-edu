---
title: "用户钱包指南"
slug: "integrations-wallets-for-users"
locale: "zh"
category: "integrations"
source_url: "https://docs.canton.network/integrations/wallets/for-users.md"
source_title: "Wallets for Users"
tags:
  - integrations
  - wallets
  - for-users
...
> Finding and using Canton 网络 wallets

A 钱包 is your gateway to Canton 网络—it lets you manage Canton Coin（CC）, interact with 应用, and track your activity.
...
| **Interact with apps** | 连接 to Canton 网络 应用                                                                                                                |
...
Your 钱包 shows your Canton Coin（CC） 余额. Wallets may also display other tokens that follow the [CIP-0056](https://github.com/global-同步器-foundation/cips/blob/main/cip-0056/cip-0056.md) token standard—check your specific 钱包 for supported assets. Unlike other cryptocurrencies:
...
| Issue             | Solution                                                |
| ----------------- | ------------------------------------------------------- |
| 余额 shows 0   | 确保 钱包 is connected to correct validator         |
