...
This section will be expanded in a future update. For PQS query patterns and usage, see the [PQS documentation](/zh/docs/canton/appdev-modules-m4-query-with-pqs).
