...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-admin-participant-v30-pruningservice-getnowaitcommitmentsfrom"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-admin-participant-v30/pruningservice/getnowaitcommitmentsfrom.md"
source_title: "GetNoWaitCommitmentsFrom"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    <div class="x2mdx-ref-breadcrumbs" role="navigation" aria-label="Breadcrumb">
      ...
      <span>获取NoWaitCommitmentsFrom</span>
    </div>
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.admin.参与方.v30.PruningService/GetNoWaitCommitmentsFrom</code>
    </div>
    ...
    ## 相关模式<手风琴组>
      ...
      <手风琴标题=“com.digitalasset.canton.admin.pruning.v30.同步器s”>
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.admin.参与方.v30.PruningService/GetNoWaitCommitmentsFrom <<'EOF'
        {
          "同步器Ids": [
            "string"
          ],
