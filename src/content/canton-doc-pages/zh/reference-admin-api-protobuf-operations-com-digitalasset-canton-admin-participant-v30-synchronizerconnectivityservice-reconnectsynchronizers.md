...
slug: "reference-admin-api-protobuf-operations-com-digitalasset-canton-admin-participant-v30-synchronizerconnectivityservice-reconnectsynchronizers"
locale: "zh"
category: "reference"
source_url: "https://docs.canton.network/reference/admin-api/protobuf/operations/com-digitalasset-canton-admin-participant-v30/synchronizerconnectivityservice/reconnectsynchronizers.md"
source_title: "ReconnectSynchronizers"
tags:
  - reference
  - admin-api
  - protobuf
...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    ...
    <div class="x2mdx-ref-operation-bar">
      ...
      <code>/com.digitalasset.canton.admin.参与方.v30.同步器ConnectivityService/Reconnect同步器s</code>
    </div>
    ...
    <手风琴组>
      <手风琴标题=“com.digitalasset.canton.admin.参与方.v30.Reconnect同步器sRequest”>
      ...
      </手风琴><手风琴标题=“com.digitalasset.canton.admin.参与方.v30.Reconnect同步器sResponse”>
    ...
    <div className="x2mdx-ref-rail-panel">
      <div className="x2mdx-ref-rail-code">
        ...
        grpcurl \
          -d @ \
          <HOST:PORT> \
          com.digitalasset.canton.admin.参与方.v30.同步器ConnectivityService/Reconnect同步器s <<'EOF'
        {
          "ignoreFailures": true
        }
        EOF
