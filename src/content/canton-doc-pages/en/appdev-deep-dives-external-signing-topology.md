...
Canton's [Topology](/docs/canton/overview-reference-topology) formalizes a shared state on a synchronizer and provides a secure, distributed mechanism for modifying this state.
