...
slug: "reference-json-api-reference-v2updatesflats"
locale: "en"
category: "reference"
source_url: "https://docs.canton.network/reference/json-api-reference/v2updatesflats.md"
source_title: "/v2/updates/flats"
tags:
  - reference
  - json-api-reference
  - v2updatesflats
...
````yaml /openapi/json-ledger-api/openapi.yaml post /v2/updates/flats
openapi: 3.0.3
info:
...
paths:
  /v2/updates/flats:
    post:
      summary: /v2/updates/flats
      description: >-
        Query flat transactions update list (blocking call). Provided for
