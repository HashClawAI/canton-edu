...
Official program repo: [canton-foundation/canton-dev-fund](https://github.com/canton-foundation/canton-dev-fund).
...
The Markdown file in this folder is ready to copy into your fork. Champion in the proposal is **@v9n** (Nguyan Vinh); adjust **dates** and **CC totals** after Committee feedback if needed.
