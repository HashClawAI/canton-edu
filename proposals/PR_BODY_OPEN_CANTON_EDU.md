...
This proposal requests Development Fund support for a **~6-month** milestone program: **(1)** official-source alignment and learning-path hardening, **(2)** developer onboarding and discoverability improvements, **(3)** sustainability documentation and metrics. Deliverables are mergeable artifacts in the public repo with EN/ZH parity and adoption-oriented metrics.
...
- [ ] Milestones and funding amounts defined *(replace `[TOTAL]`, `[M1]`–`[M3]` CC placeholders in the proposal before final review)*
